...
| Имя атрибута        | Краткое описание                                         | Домен      | Тип (простой или составной) |
| -                   | -                                                        | -          | - |
| id                  | Уникальный идентификатор пользователя                    | Число(8)   | Простой |
| Фамилия             | Часть имени пользователя                                 | Текст(32)  | Простой |
| Имя                 | Часть имени пользователя                                 | Текст(32)  | Простой |
| Отчество            | Часть имени пользователя                                 | Текст(32)  | Простой |
| Аватар              | Адрес файла с картинкой-аватаром в файловой системе      | Текст(12)  | Простой |
| Пол                 | Пол пользователя, 0 - мужской, 1 - женский               | Число(1)   | Простой |
| Дата рождения       | Дата рождения пользователя                               | Дата       | Простой |
| Страна              | Страна проживания                                        | Текст(32)  | Простой |
| Город               | Город проживания                                         | Текст(32)  | Простой |
| Телефон             | Личный номер телефона                                    | Число(10)  | Простой |
| О себе              | Произвольно заполняемая пользователем личная информация  | Текст(256) | Простой |
| Пароль              | Ключевое слово для ограничения доступа к странице        | Текст(256) | Простой |
| Отображение пола    | Отображать ли пол на странице, 0 - видит только владелец страницы, 1 - видят друзья, 2 - видят все | Число(1)   | Простой |
| Отображение ДР      | Отображать ли дату рождения на странице  | Число(1)   | Простой |
| Отображение аватара | Отображать ли аватар на странице         | Число(1)   | Простой |
| Отображение друзей  | Отображать ли список друзей на странице  | Число(1)   | Простой |
| Отображение групп   | Отображать ли список групп на странице   | Число(1)   | Простой |
| Отображение записей | Отображать ли список записей на странице | Число(1)   | Простой |
| Отображение сообщений | Возможность связаться с пользователем с помощью сообщений | Число(1)   | Простой |
| Уведомления | Показывать ли пользователю уведомления о входящих сообщениях, 0 - нет, 1 - да | Число(1) | Простой |
| Звуки | Воспроизводить ли звук уведомления | Число(1) | Простой |
| Содержимое | Отображать ли текст уведомления | Число(1) | Простой |
| Друзья | Список id друзей | Число(8) | Составной |
| Исходящие заявки | Исходящие заявки на добавление в друзья (id пользователей) | Число(8) | Составной |
| Входящие заявки | Входящие заявки на добавление в друзья (id пользователей) | Число(8) | Составной |
| Подписки | Список id групп, на которые подписан пользователь | Число(8) | Составной |
| Записи | Текст записей на странице пользователя | Текст(256) | Составной |
| Документы | Документы, прикрепленные к определенной записи на странице | Текст(12) | Составной |
| Оцененные записи | Записи пользователей и групп, которые оценил пользователь | Число(1) | Составной |
...
| Имя атрибута | Краткое описание | Домен | Тип (простой или составной) |
| - | - | - | - |
| id | Уникальный идентификатор группы | Число(8) | Простой |
| Название | Имя группы | Текст(32) | Простой |
| Аватар | Адрес файла с картинкой-аватаром в файловой системе | Текст(12) | Простой |
| id владельца | Уникальный идентификатор пользователя | Число(8) | Простой |
| О группе | Произвольно заполняемая пользователем информация о тематике группы | Текст(256) | Простой |
| Записи | Текст записей на странице группы | Текст(256) | Составной |
| Документы | Документы, прикрепленные к определенной записи на странице | Текст(12) | Составной |
...
| Имя атрибута | Краткое описание | Домен | Тип (простой или составной) |
| - | - | - | - |
| id сообщения | Уникальный идентификатор сообщения | Число(8) | Простой |
| id отправителя | id пользователя, отправившего сообщение | Число(8) | Простой |
| id получателя | id пользователя, которому предназначено сообщение | Число(8) | Простой |
| Текст сообщения | Содержимое сообщения | Текст(256) | Простой |
| Документы | Прикрепленные к сообщению документы (адрес) | Текст(12) | Составной |
