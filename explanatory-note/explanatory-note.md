...
Рисунок 5 — Страница пользователя (Entity-Relationship model)

![Страница поиска групп](img/6.jpg)

Рисунок 6 — Страница поиска групп (Entity-Relationship model)

![Страница регистрации нового пользователя](img/7.jpg)

Рисунок 7 — Страница регистрации нового пользователя
...
В процессе разработки дизайна был выявлен существенный недостаток реализуемого пользовательского интерфейса: вкладки без пиктограм не являются интуитивно понятным элементом формы. По этой причине было принято решение создать набор иконок для вкладок, а также изменить их расположение с верхнего горизонтального на левое вертикальное.

В результате переосмысления способа реализации функционала приложения был спроектирован приведенный на рисунках 8 - 10 дизайн.

![редизайн-1](img/8.png)

Рисунок 8 — Страница приветствия (режим login-register)

![редизайн-2](img/9.jpg)

Рисунок 9 — Страница регистрации (режим login-register)

![редизайн-3](img/10.png)

Рисунок 10 — Настройки приватности личной страницы пользователя

Процесс переключения между режимами был реализован аналогичным способом, но вместо удаления и создания Control'ов теперь используется обычное перемещение вверх - вниз Panel'ей и скрытие неиспользуемых элементов.
